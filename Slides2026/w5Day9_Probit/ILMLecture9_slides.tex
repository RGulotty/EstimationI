...
All three are \textbf{sample moment conditions} --- nonlinear GMM estimating equations. Find $\theta$ such that $\frac{1}{n}\sum_i g(W_i, \theta) = 0$.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Poisson QMLE for Nonnegative Outcomes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tcolorbox}[colback=blue!5, colframe=blue!50, title=Key Result (Gourieroux et al.~1984; Wooldridge 2010{,} 2023)]
...
\begin{tcolorbox}[colback=blue!5, colframe=blue!50, title=Practical Rule]
...
\begin{frame}{Best Practices: The LEF Framework (Wooldridge 2023)}
