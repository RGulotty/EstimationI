...
\medskip\pause
\begin{tcolorbox}[colback=blue!5, colframe=blue!50]
\textbf{The key move:}  When the OLS moment condition $\mathbb{E}[X_i e_i]=0$ fails, IV does not abandon the moment-condition framework---it \alert{substitutes a different, credible moment condition}.  The question remains: \emph{why should this moment hold?}
\end{tcolorbox}
\end{frame}
