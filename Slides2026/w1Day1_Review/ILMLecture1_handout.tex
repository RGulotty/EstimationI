...
$f(x,y)=6(1 - x - y),\ x,y\geq 0.$
Density is highest at $(0,0)$ and decreases as either party mobilizes more.
The 6 ensures $\int\!\int f\,dx\,dy=1$.
\begin{center}
\begin{tikzpicture}
\begin{axis}[view={45}{35}, xlabel={$x$}, ylabel={$y$}, zlabel={$f(x,y)$}, domain=0:1, y domain=0:1, samples=30, samples y=30, zmin=0, colormap/cool, width=9cm, height=5.5cm]
